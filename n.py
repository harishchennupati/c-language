...
for line in input_list:
    ...
    for score_pair in score_pairs:
        ...
        if (len(score_pairs)>3 and len(score_pairs)<=5 and (int(score_pair_split[0]) >=6 or int(score_pair_split[1]) >=6)):
                    ...
                    elif int(score_pair_split[0])<int(score_pair_split[1]): namescores[name1]['set_lost'] = int(namescores[name1]['set_lost'])+1 namescores[name2]['set_won'] = int(namescores[name2]['set_won'])+1 name2_3set_won += 1 #print(name1_5set_won) #print(name2_5set_won) #print(name1_3set_won) #print(name2_3set_won) if (name1_5set_won >=(name2_5set_won + 1)):
